...
import xg.security.custom.CustomMd5PasswordEncoder;
import xg.security.filter.TokenAuthenticationFilter;
import xg.security.filter.TokenLoginFilter;

/**
 * @author XG
 * @create 2023-04-09 14:55
 */
@Configuration
